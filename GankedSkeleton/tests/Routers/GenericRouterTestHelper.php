...
namespace Ganked\Skeleton\Routers
{
    ...
    abstract class GenericRouterTestHelper extends \PHPUnit_Framework_TestCase
    {
        ...
        protected function setUp()
        {
            ...
            $this->masterFactory->addFactory(new \Ganked\Skeleton\Factories\ControllerFactory());
            $this->masterFactory->addFactory(new \Ganked\Skeleton\Factories\BackendFactory());
            $this->masterFactory->addFactory(new \Ganked\Skeleton\Factories\QueryFactory($sessionData));
        }
