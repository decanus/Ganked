...
namespace Ganked\Frontend\Factories
{
    ...
    use Ganked\Skeleton\Factories\TransformationFactory;
    ...
    abstract class GenericFactoryTestHelper extends \PHPUnit_Framework_TestCase
    {
        ...
        protected function setUp()
        {
            ...
            $this->masterFactory->addFactory(new RouterFactory($sessionData));
            ...
            $this->masterFactory->addFactory(new LocatorFactory);
