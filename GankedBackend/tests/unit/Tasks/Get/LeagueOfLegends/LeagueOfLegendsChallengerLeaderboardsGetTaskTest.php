...
namespace Ganked\Backend\Tasks
{
    ...
    /**
     * @covers Ganked\Backend\Tasks\LeagueOfLegendsChallengerLeaderboardsGetTask
     */
    class LeagueOfLegendsChallengerLeaderboardsGetTaskTest extends \PHPUnit_Framework_TestCase
    {
        /**
         * @var LeagueOfLegendsChallengerLeaderboardsGetTask
         */
        private $task;
        private $curl;
        private $uri;
        ...
        protected function setUp()
        {
            ...
            $this->task = new LeagueOfLegendsChallengerLeaderboardsGetTask(
                $this->curl,
                $this->uri,
